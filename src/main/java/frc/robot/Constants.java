...
public final class Constants {
  ...
  public static final class ModuleConstants {
   ...
   public static final double kDriveMotorticks2mps=kWheelCircumfrenceMeters * (1.0 / 8.14)*(1 / 60.0);
    ...
    public static final double kPModuleDriveController = 0.42; // 0.4
    public static final double kIModuleDriveController = 0.1;
    public static final double kDModuleDriveController = 0.000;
    public static final double kFFModuleDriveController = 0.238;
  }
